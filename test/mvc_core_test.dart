...
// Test Controllers - these need to be classes for proper lifecycle
class _LifecycleController extends MvcController<int> {
  ...
  @override
  MvcView view() {
    return MvcViewBuilder<_LifecycleController>(
      (controller) => Scaffold(
...
class _CounterController extends MvcController<void> {
  ...
  @override
  MvcView view() {
    return MvcViewBuilder<_CounterController>(
      (controller) => Scaffold(
...
class _InteractiveController extends MvcController<void> {
  ...
  @override
  MvcView view() {
    return MvcViewBuilder<_InteractiveController>(
      (controller) => Scaffold(
        body: Column(
          children: [
